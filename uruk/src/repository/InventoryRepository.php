...
class InventoryRepository
{
    ...
    public function select_equip_upgrade_data(int $item_type_id, int $grade_id, int $step)
    {
    ...
    public function select_equip_repair_data(int $item_type_id)
    {
        $sql = "SELECT * FROM durability_repair_data WHERE item_type_id=:itemTypeId";
     ...
     */
    public function select_equip_data(Equipment $equipment)
    {
