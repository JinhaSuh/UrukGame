...
CREATE TABLE `map_fish_drop_data` (
  ...
  CONSTRAINT `mapFish` FOREIGN KEY (`fish_id`) REFERENCES `fish_data` (`fish_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `mapId` FOREIGN KEY (`map_id`) REFERENCES `map_data` (`map_id`) ON DELETE CASCADE ON UPDATE CASCADE
