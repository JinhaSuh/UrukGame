...
CREATE TABLE `bait_data` (
  ...
  CONSTRAINT `baitGrade` FOREIGN KEY (`grade_id`) REFERENCES `grade_type_data` (`grade_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `baitItem` FOREIGN KEY (`item_type_id`) REFERENCES `item_type_data` (`item_type_id`) ON DELETE CASCADE ON UPDATE CASCADE
